...
class studentClass:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Manage Student Details", font=(
            "times new roman", 20, "bold"), bg="#005470", fg="white").place(x=10, y=15, width=1517, height=35)
        ...
        lbl_city = Label(self.root, text="City", font=(
            "goudy old style", 15, 'bold'), bg='white').place(x=320, y=220)
        ...
        self.btn_add = Button(self.root, text="Save", font=(
            "goudy old style", 15, "bold"), bg="#187898", fg="white", cursor="hand2", command=self.add)
        self.btn_add.place(x=150, y=400, width=110, height=40)
        self.btn_add = Button(self.root, text="Update", font=(
            "goudy old style", 15, "bold"), bg="#D8B537", fg="white", cursor="hand2", command=self.update)
        self.btn_add.place(x=270, y=400, width=110, height=40)
        self.btn_add = Button(self.root, text="Delete", font=(
            "goudy old style", 15, "bold"), bg="#5F3F9E", fg="white", cursor="hand2", command=self.delete)
        ...
        lbl_search_roll = Label(self.root, text="Search By | Roll No.", font=(
            "goudy old style", 15, 'bold'), bg='white').place(x=870, y=60)
        txt_search_roll = Entry(self.root, textvariable=self.var_search, font=(
            "goudy old style", 15, 'bold'), bg='lightyellow').place(x=1100, y=60, width=180)
        btn_search = Button(self.root, text="Search", font=(
            "goudy old style", 15, "bold"), bg="#03a9f4", fg="white", cursor="hand2", command=self.search).place(x=1290, y=60, width=120, height=28)
...
# =============================================================================
    ...
    def delete(self):
        con = sqlite3.connect(database='cms.db')
        cur = con.cursor()
        try:
